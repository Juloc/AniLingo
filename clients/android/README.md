...
From this directory with Android SDK 37 available:
...
The next delivery slice connects the server-side `/api/client/v1` endpoints, same-origin phone WebView shell, and native episode bootstrap/player flow.
