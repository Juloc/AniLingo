...
namespace AniLingo.Web.Data.Migrations
{
    ...
    [Migration("20260926201825_AddAcquisitionApiKeys")]
    partial class AddAcquisitionApiKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AniLingo.Web.Features.Acquisition.Api.AcquisitionApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AniLingo.Web.Features.Acquisition.History.AcquisitionHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("AnimeId", "SeasonNumber", "EpisodeNumber", "OccurredAtUtc");
            ...
            modelBuilder.Entity("AniLingo.Web.Features.MediaSegments.EpisodeSegmentDetectionState", b =>
                {
                    b.Property<Guid>("EpisodeId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AniLingo.Web.Features.Novels.NovelTranslation", b =>
                {
                    ...
                    b.HasIndex("ChapterId", "TargetLanguage", "ProviderId", "PromptVersion", "SourceHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("AniLingo.Web.Features.Novels.NovelWork", b =>
                {
                    ...
                    b.HasIndex("MetadataProvider", "MetadataExternalId")
                        .IsUnique();

                    b.HasIndex("SourceProvider", "SourceKey")
                        .IsUnique();
            ...
            modelBuilder.Entity("AniLingo.Web.Features.Progress.EpisodePlaybackHistoryEntry", b =>
                {
                    ...
                    b.ToTable("EpisodePlaybackHistory", (string)null);
                });
